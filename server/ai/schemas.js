...
export const FlashcardsStudySetSchema = z.object({
  ...
  title: z.string().min(1).default('Untitled Study Set'),
...
export const QuizStudySetSchema = z.object({
  type: z.literal('quiz'),
  title: z.string().min(1).default('Untitled Quiz Set'),
  difficulty: z.enum(['easy', 'medium', 'hard']).optional().default('medium'),
...
export const GenerateRequestSchema = z.object({
  input: z.string().min(1, 'Input notes or topic cannot be empty').max(15000),
